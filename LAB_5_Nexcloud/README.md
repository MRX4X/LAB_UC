...
3. Авторизуйте под пользователем admin.
...
## 5. Открытие Nextcloud

1. Создайте четырех пользователей.
2. Авторизуйтесь под этими пользователями.
3. Объедините двух пользователей в группу.
3. Создай общую папки и расшарьте ее для группы.
4. Проверьте, что от пользователя группы есть доступ к папке, загрузите любой файл.
5. Проверьте, что от пользователя не в группе доступа нет.